-- Dica: Se precisar rodar de novo, descomente as linhas abaixo para limpar o banco antes
-- DROP TABLE IF EXISTS ITEM_VENDA, VENDA, LOTE, PRODUTO, TELEFONE_CLIENTE, CLIENTE, FORNECEDOR, CATEGORIA CASCADE;
